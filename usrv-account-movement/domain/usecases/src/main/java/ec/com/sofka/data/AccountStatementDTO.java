...
public class AccountStatementDTO {
    ...
    public AccountStatementDTO(String accountNumber, BigDecimal accountInitialBalance, BigDecimal accountAvailableBalance, String accountType, String customerName, boolean status, BigDecimal movementAmount, LocalDateTime date) {
